...
public class MainActivity extends Activity {
    ...
    private void getRestaurantAPI() {
        final NetworkAsyncTask httpsTask = new NetworkAsyncTask(1000, mCurrentLocation.getLongitude(), mCurrentLocation.getLatitude());
        httpsTask.execute();
        ...
        try {
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    Log.e("\nRestaurant Names : ", eElement.getElementsByTagName("name").toString());
                    Log.e( "key : ", eElement.getAttribute("k").toString());
    ...
    private void init() {
        ...
        txtLocationResult=findViewById(R.id.txt_location);
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            // location last updated time
            //txtLocationResult.setText("Last updated on: " + mLastUpdateTime);
            txtLocationResult.setText(
                    "Lat: " + mCurrentLocation.getLatitude() + ", " +
                            "Lng: " + mCurrentLocation.getLongitude()
            );
